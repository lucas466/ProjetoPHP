...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div id="Sucesso_Inserir" class="alert alert-success alert-dismissible" style="display: none">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
		<h4><i class="icon fa fa-check"></i> Sucesso!</h4>
		Cadastrado com sucesso.
    </div>
        
    <div id="Sucesso_Atualizar" class="alert alert-success alert-dismissible" style="display: none">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
		<h4><i class="icon fa fa-check"></i> Sucesso!</h4>
		Atualizado com sucesso.
    </div>
        
    <div id="Erro_Inserir" class="alert alert-danger alert-dismissible" style="display: none">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <h4><i class="icon fa fa-ban"></i> Erro!</h4>
		Problema ao inserir.
    </div>
              
    <div id="Erro_Atualizar" class="alert alert-danger alert-dismissible" style="display: none">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <h4><i class="icon fa fa-ban"></i> Erro!</h4>
      ...
      <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <div id="grupo" style="margin-left: 15pt; color: rgb(66, 66, 66)">
                    ...
                    <input  type="radio" id="Radio_Juridica" name="NIVEL_ACESSO" value="1" onclick="ChamaJuridica()"> <span>Pessoa jurídica</span>
                    </label>
                
                
                    <label class="radio-inline" style="margin-left: 15pt">
                    <input type="radio" id="Radio_Fisica" name="NIVEL_ACESSO" value="2" onclick="ChamaFisica()" ><span>Pesssoa física</span>
                    </label>
                  ...
                  <div class="card-body">
                    ...
                    echo $_SESSION["Valores_Juridica"][0]["CNPJ"];
                        ...
                        ?>" 
                        class="form-control" id="CNPJ" name="CNPJ" required="" oninput="TestaCNPJ_Mensagem(this)">
                     ...
                     echo $_SESSION["Valores_Juridica"][0]["RAZAOSOCIAL"];
                        ...
                        ?>" 
                        class="form-control" id="RAZAO_SOCIAL" name="RAZAO_SOCIAL" required="" maxlength="40">
                      </div>
                      <div class="col-md-3">
                      ...
                      echo $_SESSION["Valores_Juridica"][0]["NOMEFANTASIA"];
                        ...
                        ?>" 
                          class="form-control" id="NOME_FANTASIA" name="NOME_FANTASIA" required="" maxlength="40">
                      </div>
      
                        <div class="col-md-3">
                            <label> Indicador de inscrição estadual </label><span style="color: red">*</span>
                            <select class="form-control not-required" type="text" id="IN_INS_ESTADUAL" name="IN_INS_ESTADUAL" onchange="Habilita_Estadual()" required="">
                  ...
                  ?>" class="form-control" id="IN_ESTADUAL" name="IN_ESTADUAL" readonly="true" maxlength="20">
                        </div>
                  ...
                  ?>" class="form-control" id="INS_MUNICIPAL" name="INS_MUNICIPAL" maxlength="15">
                        </div>
                  ...
                  ?>" class="form-control" id="SI_CNPJ" name="SI_CNPJ" readonly="true" maxlength="30">
                        </div>

                        <div class="col-md-3">
                            <label> Recolhimento </label><span style="color: red">*</span>
                            <select class="form-control not-required" type="text" id="RECOLHIMENTO" name="RECOLHIMENTO" required="">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control not-required" type="text" id="ATIVO_JURIDICO" name="ATIVO_JURIDICO" required="">
...
?>" class="form-control" id="CPF" name="CPF" onblur="TestaCPF_Mensagem(this)">
                      </div>
                      <div class="col-md-6">
...
?>" class="form-control" id="APELIDO" name="APELIDO" maxlength="25">
                      </div>
...
?>"  class="form-control" id="RG" name="RG">
                        ...
                        <div class="col-md-3">
                            <label> Ativo </label><span style="color: red">*</span>
                            <select class="form-control not-required" type="text" id="ATIVO_FISICO" name="ATIVO_FISICO">
...
?>" class="form-control" id="TELEFONE" name="TELEFONE" required="" maxlenght="15">
                  </div>

                  <div class="col-md-3">
                      <label> Tipo </label><span style="color: red">*</span>
                      <select class="form-control not-required" type="text" id="TIPOTEL" name="TIPOTEL" required="">
...
?>" class="form-control" id="EMAIL" name="EMAIL" maxlength="30">
                  ...
                  <div class="col-md-3">
                      <label> Tipo </label>
                      <select class="form-control not-required" type="text" id="TIPO_MAIL_PRINCIPAL" name="TIPO_MAIL_PRINCIPAL">
...
?>" class="form-control" id="NOMEAD" name="NOMEAD" maxlength="30">
                    </div>
...
?>" class="form-control" id="EMPRESA" name="EMPRESA" maxlength="30">
                    </div>
...
?>" class="form-control" id="CARGOAD" name="CARGOAD" maxlength="25">
                  </div>
...
?>" class="form-control" id="TELEFONEAD" name="TELEFONEAD" maxlength="15">
                </div>

                    <div class="col-md-3">
                        <label> Tipo </label>
                        <select class="form-control not-required" type="text" id="TIPOTE_TELAD" name="TIPOTE_TELAD">
...
?>" class="form-control" id="EMAILAD" name="EMAILAD" maxlength="30">
                  </div>

                  <div class="col-md-3">
                    <label> Tipo </label>
                    <select class="form-control not-required" type="text" id="TIPO_MAIL_AD" name="TIPO_MAIL_AD">
...
?> " class="form-control" id="CEP" name="CEP" required="" maxlength="9">
                    </div>
...
?>" class="form-control" id="LOGRADOURO" name="LOGRADOURO" required="" maxlength="40">
                    </div>
...
?>" class="form-control" id="NUMERO" name="NUMERO" required="" maxlength="5">
                  </div>
...
?>" class="form-control" id="COMPLEMENTO" name="COMPLEMENTO" maxlength="15">
                </div>
...
?>"  class="form-control" id="BAIRRO" name="BAIRRO" required="" maxlength="25">
                </div>
...
?>" class="form-control" id="REFERENCIA" name="REFERENCIA" maxlength="40">
                </div>

                <div class="col-md-3">
                  <label> UF </label><span style="color: red">*</span>
                  <select class="form-control not-required" type="text" id="UF" name="UF" onchange="Habilita_Cidade()" required="">
...
?>
            ...
            <div class="col-md-3">
              ...
              <select class="form-control not-required" type="text" id="CONDOMINIO" name="CONDOMINIO" 
              required="">
          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body pad">
                <div class="mb-3">
                  <textarea class="textarea" placeholder="Digite a observação" id="OBSERVACAO" name="OBSERVACAO"
...
?></textarea>
      ...
      <div class="row">
          ...
          <div class="row no-print" style="margin-left: 20px; margin-bottom: 20px">
             <div class="col-12">
               <button class="btn btn-success float-right"><i class="fa fa-plus-square"></i> Cadastrar usuário
               </button>
             </div>
           </div>
         </div> 
...
<script>
  ...
  //Verifica se o cnpj esta certo quando o usuario tentar inserir
   function TestaCNPJ_Mensagem(input) {

    var CNPJ = document.getElementById("CNPJ").value;  
		
		var CNPJ_A = CNPJ.replace(/\D/g, "");

    var dados = new Array();

    $.ajax({
		        url: "https://www.receitaws.com.br/v1/cnpj/"+CNPJ_A,
		        method: 'GET',
		        dataType:'jsonp',
		        headers: {
              ...
              input.setCustomValidity('');
                ...
                input.setCustomValidity("CNPJ inválido ou a api chegou ao limite por agora.");
              }
		        }, error: function() {
              input.setCustomValidity("CNPJ inválido ou a api chegou ao limite por agora.");
  ...
  //Verifica se o cpf esta certo quando o usuario tentar inserir
   function TestaCPF_Mensagem(input) {
    if (VerificaCPF()) {
    input.setCustomValidity('');
    } else {
...
//Habilita campo estadual 
function Habilita_Estadual() {
  var estadual = document.getElementById("IN_ESTADUAL");
  var valor = document.getElementById("IN_INS_ESTADUAL");

  var texto = valor.options[valor.selectedIndex].text;

  if(!texto.includes("Selecione")){
...
function Habilita_Cidade() {
  ...
  //Verica se o CNPJ e valido e verifica com a api
		 ...
		 $.ajax({
		        ...
		        success: function(dados) {
		        	...
		        	if(dados["message"] == null){
		        		...
		        		document.getElementById("SI_CNPJ").value =  dados["situacao"];
                $('#CEP').mask('000000-00').val(dados["cep"]).trigger('input');
		        		VerificaCEP();
              }
		        }});
            }}

  //Verifica se o codigo do governo retorna o valor verdadeiro          
  function VerificaCPF(){
   ...
   //Verifica se o cep e valido e preenche os campos
  function VerificaCEP(){
		...
		if(CEP.length == 9){
			...
			var CEP_Numeros = CEP.replace(/\D/g, "");

			 var dados = new Array();
				
			 $.ajax({
			        url: "https://viacep.com.br/ws/"+CEP_Numeros+"/json/",
			        method: 'GET',
			        dataType:'jsonp',
			        headers: {
			            'Content-Type': 'application/json',
			        ...
			        success: function(dados) {
			        	...
			        	if(dados["cep"] != null){
			        		...
			        		Habilita_Cidade();
			        		document.getElementById('SELECT_CIDADE').value = dados["localidade"];
...
?>";
	  ...
	  var Resultado_Acao = " <?php
@session_start();
echo @$_SESSION["Resultado_Inserir_Atualiza"];
unset($_SESSION["Resultado_Inserir_Atualiza"]);
?> "; 
		  
		  if(Resultado_Acao == 1){

			  var Sucesso = document.getElementById("Sucesso_Inserir");
			  Sucesso.style.display = "block";

		  }else if(Resultado_Acao == 2){

			  var Erro = document.getElementById("Erro_Inserir");
			  Erro.style.display = "block";

	      }else if(Resultado_Acao == 3){

	    	  var Sucesso = document.getElementById("Sucesso_Atualizar");
	    	  Sucesso.style.display = "block";
	    	  
		  }else if(Resultado_Acao == 4){

			  var Erro = document.getElementById("Erro_Atualizar");
			  Erro.style.display = "block";
  ...
  $("#RG").mask("00000.000-0");
    ...
    $("#TELEFONEAD").bind("keyup",function(e){
    	$("#TELEFONEAD").mask("(00) 00000-0000");
	});
